  ...
  return (
    <div className="px-8 pt-10 pb-20 max-w-6xl mx-auto space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-8">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Resultados y Rendimiento</h1>
          <p className="text-sm text-slate-500 mt-2">
            Visualiza y segmenta las métricas consolidadas de tus campañas de pauta publicitaria.
          </p>
        </div>
        <div className="flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-2.5 rounded-2xl border border-emerald-100/60 text-xs font-bold shadow-sm self-start">
